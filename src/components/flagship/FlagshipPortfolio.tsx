      ...
      <div className="container max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-5 gap-6 mb-10">
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-muted/50">
                    ...
                    <TableHead className="text-right font-semibold">{ko ? '배분 (%)' : 'Allocation (%)'}</TableHead>
                    ...
                    <AccordionItem key={group.id} value={group.id} className="border-b last:border-b-0">
                      <AccordionTrigger className="px-4 py-3 hover:no-underline hover:bg-muted/30">
                        <div className="flex items-center w-full">
                          ...
                          <div className={`w-24 text-right text-sm font-mono hidden sm:flex items-center justify-end gap-1 ${perfColor}`}>
          ...
          <div className="lg:col-span-2">
            <FlagshipCharts items={items} groups={groups} groupWeights={groupWeights} />
          </div>
        </div>
        ...
        {/* Disclaimer */}
        <p className="text-[11px] text-muted-foreground text-center mt-8 max-w-3xl mx-auto leading-relaxed">
          {ko
