...
BEGIN
  ...
  -- Allow webmaster to sponsor another webmaster (same level)
  -- For all other roles, sponsor must be strictly higher
  IF parent_role = 'webmaster' AND NEW.sales_role = 'webmaster' THEN
    -- allowed
    NULL;
  ELSIF parent_role_level >= new_role_level THEN
