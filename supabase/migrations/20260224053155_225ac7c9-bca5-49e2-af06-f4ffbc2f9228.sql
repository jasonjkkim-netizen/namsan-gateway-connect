...
BEGIN
  ...
  -- Define role hierarchy levels (updated with deputy_district_manager)
  -- district_manager=1, deputy_district_manager=2, principal_agent=3, agent=4, client=5
  ...
  -- Enforce max 5 sub-layers (updated from 4)
